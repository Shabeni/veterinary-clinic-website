...
?>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="page-title">
                        <h3 class="my-0">Create new Type</h3>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-12 col-md-6">
            ...
            <input type="number" name="actif" class="form-control" value="1" />
        </div>
    </div>
...
var_dump($p);
print '</pre>';*/
if($p->Create()) echo "<script>window.location.href = 'types.php';
</script>";
else echo 'Erreur  !!!';
