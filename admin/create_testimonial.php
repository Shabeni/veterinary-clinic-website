...
<head>
    ...
    <!-- title -->
    <title>PetWell- Create Testimonial</title>
...
?>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="page-title">
                        <h3 class="my-0">Add a Testimonial</h3>
    ...
    <div class="form-group row">
        <div class="col-sm-12 col-md-6 mb-3">
            <label for="" class="mb-2">Client:</label>
    ...
    <label for="" class="mb-2">Testimonial:</label>
...
include_once('CLASSE/testimonial.class.php');
$p=new Testimonial('localhost','root','','veterinarian');
$p->client_name=$_POST['client'];
$p->testimonial=$_POST['testimonial'];
